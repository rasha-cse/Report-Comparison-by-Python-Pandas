...
input_therap_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\selected_columns_therap_file_all_date_fields_" + date + ".xlsx"
input_sis_online_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\selected_columns_sis_online_all_date_fields_" + date + ".xlsx"
output_exists_both_sides_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\exists_both_with_date_fields_" + date + ".xlsx"


input_therap_dataframe = pd.read_excel(input_therap_path, sheetname='Sheet1', na_values=['NA'])
...
exists_both_sides.rename(columns={'SIS_STATUS': 'SIS_STATUS_THERAP', 'CREATED': 'CREATED_AT_THERAP', 'UPDATED': 'UPDATED_AT_THERAP', 'dateUpdated_SIS_Online': 'Date_Updated_SIS_Online'}, inplace=True)

exists_both_sides['Matched/Mismatched?'] = np.where(exists_both_sides['SIS_STATUS_THERAP'] == exists_both_sides['SIS_STATUS_SIS_Online'], 'Matched', 'Mismatched')  #Matched/Mismatched?

exists_both_sides = exists_both_sides[['SIS_ID', 'SIS_TRACKING_NUM', 'SIS_STATUS_THERAP', 'SIS_STATUS_SIS_Online', 'Matched/Mismatched?', 'CREATED_AT_THERAP', 'UPDATED_AT_THERAP', 'STATUS_CHANGE_DATE', 'COMPLETED_DATE', 'Date_Updated_SIS_Online']]
