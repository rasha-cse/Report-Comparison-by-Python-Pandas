...
input_therap_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\concatenated_therap_" + date + ".xlsx"
input_sis_online_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\concatenated_sis_online_" + date + ".xlsx"
output_concatenated_comparison_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\concatenated_comparison_" + date + ".xlsx"
...
input_sis_online_dataframe.rename(columns={'SIS_ID_SIS_Online' : 'SIS_ID', 'dateUpdated_SIS_Online_SIS_Online': 'dateUpdated_SIS_Online', 'Concatenated_SIS_Online_SIS_Online': 'Concatenated_SIS_Online'}, inplace=True)
...
def sis_online_sis_status_formation(dataframe):
    if dataframe['locked_SIS_Online'] == True:
        dataframe['SIS_STATUS'] = dataframe['statusText_SIS_Online'] + '_LOCKED'
    else:
        dataframe['SIS_STATUS'] = dataframe['statusText_SIS_Online']
    return dataframe['SIS_STATUS']
...
exists_both_sides = exists_both_sides[['SIS_ID', 'FIRST_NAME_THERAP', 'LAST_NAME_THERAP', 'SIS_TRACKING_NUM_THERAP', 'SIS_STATUS_THERAP', 'CREATED_THERAP', 'UPDATED_THERAP', 'STATUS_CHANGE_DATE_THERAP', 'COMPLETED_DATE_THERAP', 'EXPIRATION_DATE_THERAP', 'HOME_LIVING_RAW_THERAP', 'HOME_LIVING_STANDARD_THERAP', 'HOME_LIVING_PERCENTILE_THERAP', 'COMMUNITY_LIVING_RAW_THERAP', 'COMMUNITY_LIVING_STANDARD_THERAP', 'COMMUNITY_LIVING_PERCENTILE_THERAP', 'LIFELONG_LEARNING_RAW_THERAP', 'LIFELONG_LEARNING_STANDARD_THERAP', 'LIFELONG_LEARNING_PERCENTILE_THERAP', 'EMPLOYMENT_RAW_THERAP', 'EMPLOYMENT_STANDARD_THERAP', 'EMPLOYMENT_PERCENTILE_THERAP', 'HEALTH_SAFETY_RAW_THERAP', 'HEALTH_SAFETY_STANDARD_THERAP', 'HEALTH_SAFETY_PERCENTILE_THERAP', 'SOCIAL_RAW_THERAP', 'SOCIAL_STANDARD_THERAP', 'SOCIAL_PERCENTILE_THERAP', 'TOTAL_SCORE_NEEDED_INDEX_THERAP', 'EXCEPTION_MEDICAL_TOTAL_THERAP', 'EXCEPTION_BEHAVE_TOTAL_THERAP', 'Concatenated_Therap', 'Matched/Mismatched?', 'Concatenated_SIS_Online', 'First_Name_SIS_Online', 'Last_Name_SIS_Online', 'Tracking Number_SIS_Online', 'SIS_STATUS_SIS_Online', 'dateUpdated_SIS_Online', 'HOME_LIVING_RAW_SIS_Online', 'HOME_LIVING_STANDARD_SIS_Online', 'HOME_LIVING_PERCENTILE_SIS_Online', 'COMMUNITY_LIVING_RAW_SIS_Online', 'COMMUNITY_LIVING_STANDARD_SIS_Online', 'COMMUNITY_LIVING_PERCENTILE_SIS_Online', 'LIFELONG_LEARNING_RAW_SIS_Online', 'LIFELONG_LEARNING_STANDARD_SIS_Online', 'LIFELONG_LEARNING_PERCENTILE_SIS_Online', 'EMPLOYMENT_RAW_SIS_Online', 'EMPLOYMENT_STANDARD_SIS_Online', 'EMPLOYMENT_PERCENTILE_SIS_Online', 'HEALTH_SAFETY_RAW_SIS_Online', 'HEALTH_SAFETY_STANDARD_SIS_Online', 'HEALTH_SAFETY_PERCENTILE_SIS_Online', 'SOCIAL_RAW_SIS_Online', 'SOCIAL_STANDARD_SIS_Online', 'SOCIAL_PERCENTILE_SIS_Online', 'TOTAL_SCORE_NEEDED_INDEX_SIS_Online', 'EXCEPTION_MEDICAL_TOTAL_SIS_Online', 'EXCEPTION_BEHAVE_TOTAL_SIS_Online']]
