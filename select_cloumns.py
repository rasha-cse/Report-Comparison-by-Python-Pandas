...
sis_online_input_file_for_Concatenate = 'SIS_Online_6_nov_2017_prod.csv'
therap_file_for_concatenation = 'therap_all_scores_dates_6_nov_2017_production(2).xlsx'
date = '6_nov_2017'

input_sis_online_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\input" + "\\"  + sis_online_input_file_for_Concatenate
input_therap_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\input" + "\\" + therap_file_for_concatenation

output_sis_online_for_concatenate_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\selected_columns_sis_online_for_concatenate_" + date + ".xlsx"
output_therap_file_for_concatenate_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\selected_columns_therap_file_for_concatenate_" + date + ".xlsx"
output_sis_online_for_concatenate_path_reuse = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\input\selected_columns_sis_online_for_concatenate_" + date + ".xlsx"
output_sis_online_all_date_fields_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\selected_columns_sis_online_all_date_fields_" + date + ".xlsx"
output_therap_with_all_date_fields_path = r"C:\Users\rasha\PycharmProjects\SIS_Comparison_Report\output\selected_columns_therap_file_all_date_fields_" + date + ".xlsx"
...
sis_online_selected_columns_for_concatenated = delete_first_row[['formResultId', 'sis_track_num', 'sis_cl_first_nm', 'sis_cl_last_nm', 'statusText', 'locked', 'dateUpdated', 'scr_2A_raw', 'scr_2A_std', 'scr_2A_pct', 'scr_2B_raw', 'scr_2B_std', 'scr_2B_pct', 'scr_2C_raw', 'scr_2C_std', 'scr_2C_pct', 'scr_2D_raw', 'scr_2D_std', 'scr_2D_pct', 'scr_2E_raw', 'scr_2E_std', 'scr_2E_pct', 'scr_2F_raw', 'scr_2F_std', 'scr_2F_pct', 'scr_support_needs_index', 'scr_1A_raw_total', 'scr_1B_raw_total']]
sis_online_selected_columns_for_concatenated.rename(columns={'formResultId': 'SIS_ID', 'sis_track_num': 'Tracking Number', 'sis_cl_first_nm': 'First_Name', 'sis_cl_last_nm': 'Last_Name', 'dateUpdated': 'dateUpdated_SIS_Online', 'scr_2A_raw': 'HOME_LIVING_RAW', 'scr_2A_std': 'HOME_LIVING_STANDARD', 'scr_2A_pct': 'HOME_LIVING_PERCENTILE', 'scr_2B_raw': 'COMMUNITY_LIVING_RAW', 'scr_2B_std': 'COMMUNITY_LIVING_STANDARD', 'scr_2B_pct': 'COMMUNITY_LIVING_PERCENTILE', 'scr_2C_raw': 'LIFELONG_LEARNING_RAW', 'scr_2C_std': 'LIFELONG_LEARNING_STANDARD', 'scr_2C_pct': 'LIFELONG_LEARNING_PERCENTILE', 'scr_2D_raw': 'EMPLOYMENT_RAW', 'scr_2D_std': 'EMPLOYMENT_STANDARD', 'scr_2D_pct': 'EMPLOYMENT_PERCENTILE', 'scr_2E_raw': 'HEALTH_SAFETY_RAW', 'scr_2E_std': 'HEALTH_SAFETY_STANDARD', 'scr_2E_pct': 'HEALTH_SAFETY_PERCENTILE', 'scr_2F_raw': 'SOCIAL_RAW', 'scr_2F_std': 'SOCIAL_STANDARD', 'scr_2F_pct': 'SOCIAL_PERCENTILE', 'scr_support_needs_index': 'TOTAL_SCORE_NEEDED_INDEX', 'scr_1A_raw_total': 'EXCEPTION_MEDICAL_TOTAL', 'scr_1B_raw_total': 'EXCEPTION_BEHAVE_TOTAL'}, inplace=True)
...
therap_file_selected_columns_with_date_fields = therap_file[['SIS_ID', 'SIS_TRACKING_NUM', 'SIS_STATUS', 'CREATED', 'UPDATED', 'STATUS_CHANGE_DATE', 'COMPLETED_DATE', 'EXPIRATION_DATE']]
